...
you should place your code here."
  ...
  (add-hook 'after-make-frame-functions
            (lambda (new-frame)
              ...
              (if (window-system new-frame)
                  (progn
                    (spacemacs//set-monospaced-font "DejaVu Sans Mono" "WenQuanYi Micro Hei Mono" 13 13)))))

  (evilified-state-evilify youdao-dictionary-mode youdao-dictionary-mode-map)
  (spacemacs/set-leader-keys "d" 'youdao-dictionary-search)
